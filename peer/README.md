...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/btcziggurat/btcd/peer)
...
```bash
$ go get -u github.com/btcziggurat/btcd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/btcziggurat/btcd/peer#example-package--NewOutboundPeer)  
