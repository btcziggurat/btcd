...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/btcziggurat/btcd/connmgr)
...
```bash
$ go get -u github.com/btcziggurat/btcd/connmgr
```
