...
* Unlike bitcoind that has the wallet and chain intermingled in the same process
  ...
  [btcwallet](https://github.com/btcziggurat/btcwallet).
...
such as [btcwallet](https://github.com/btcziggurat/btcwallet) for inter-process
...
[btcrpcclient](https://github.com/btcziggurat/btcrpcclient) package.
...
[btcrpcclient](https://github.com/btcziggurat/btcrpcclient) package to connect with
...
import (
	"github.com/btcziggurat/btcrpcclient"
